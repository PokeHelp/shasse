    ...
    if (type === "password")
    {
        return (
            <div className="relative">
                ...
                <Button type="button" className={"absolute right-0 top-1/2 -translate-y-1/2 h-8 w-8 p-0 border-primary bg-transparent border fill-primary hover:fill-background"}
