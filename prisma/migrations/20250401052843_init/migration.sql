...
CREATE TABLE `owned_pokemon` (
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    `shiny_hunting_id` BIGINT UNSIGNED NOT NULL,
    ...
    INDEX `owned_pokemon_shiny_hunting_id_fkey`(`shiny_hunting_id`),
...
-- AddForeignKey
ALTER TABLE `owned_pokemon` ADD CONSTRAINT `owned_pokemon_shiny_hunting_id_fkey` FOREIGN KEY (`shiny_hunting_id`) REFERENCES `shiny_hunting`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
