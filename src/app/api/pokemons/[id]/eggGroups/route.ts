...
import {EggGroupGenerationResponse} from "@types";

export async function GET(request: NextRequest, {params}: {
    params: Promise<{ id: string, generationId?: string | null }>
}): Promise<NextResponse<EggGroupGenerationResponse>>
{
    try
    {
        ...
        return sendResponse({
            success: true,
            data:    (await getPokemonEggGroupWithTranslation(idPassed.data, generationId))
        }, HttpStatusCode.Ok);
    } catch (e)
    {
        console.log(e)
